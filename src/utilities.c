...
void exec_filter_rel_exists(predicate pred ,int rel_index , uint64_t number , mid_results** mid_results_arr)
{   
...
{   
    ...
    {   
        exec_filter_rel_exists(pred,relation_exists , *number , mid_results_arr);
    }
